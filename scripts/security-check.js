#!/usr/bin/env node
// Lightweight wrapper around `npm audit` for CI
// Runs `npm audit --omit=dev --json`, prints a human-friendly summary
// Exits with code 1 if any HIGH or CRITICAL vulnerabilities are present.
