...
export function middleware(request: NextRequest) {
  ...
  const cspHeader = [
    ...
    `connect-src 'self' https: wss: ws: https://*.walletconnect.com https://*.walletconnect.org https://*.metamask.io https://*.rainbow.me https://*.coinbase.com https://*.trustwallet.com https://*.alchemy.com https://*.monad.xyz https://*.ethereum.org https://*.infura.io https://*.quicknode.com https://*.moralis.io https://*.web3modal.com https://api.web3modal.org https://pulse.walletconnect.org https://cloud.reown.com https://*.web3js.org https://*.ipfs.io https://*.ipfs.dweb.link https://*.gateway.pinata.cloud https://media.gateway.pinata.cloud https://*.cloudflare-ipfs.com https://*.arweave.net https://*.nftstorage.link https://nft-cdn.alchemy.com https://dweb.link https://cf-ipfs.com https://ipfs.decentralized-content.com https://ipfs.runfission.com https://ipfs.eth.arweave.network https://ipfs.infura.io https://ipfs.fleek.co https://hardbin.com`,
